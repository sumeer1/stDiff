...
from starmapmodel import DiffusionModel, MyDDPM
...
def parse_args():
    ...
    parser.add_argument('--exclude-bregma', type=int, default=2, help="Bregma value to exclude from the dataset")
        ...
        with torch.no_grad():
            ...
            if slice1_data and slice2_data and target_slice_data:
                ...
                for lambda_val in np.arange(0.1, 1.0, 0.1):
                    ...
                    interpolated_save_path = os.path.join(base_dir, f"starmapslice2_lambda_{lambda_val:.1f}.csv")
